...
const getCurrentIcon = () => themeButton.classList.contains(iconTheme) ? 'ri-moon-line' : '<i class="ri-sun-line"></i>'
...
// Thêm hoặc xóa chủ đề biểu tượng / tối
    ...
    // Chúng ta lưu theme và icon hiện tại mà người dùng đã chọn
